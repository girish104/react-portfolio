        ...
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-10 lg:w-1/2">
            ...
            <p className="font-medium text-base text-secondary max-w-xl lg:text-lg">
              Hi! I just finished my Master's in Computer Science. I like coding
              and making cool things. I very excited about what comes next!
            </p>
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <h3 className="font-semibold text-dark text-2xl mb-3 lg:text-3xl lg:pt-10">
              Let's be friends
            </h3>
            <p className="font-medium text-base text-secondary max-w-xl mb-6">
              If you like my work or have referrals to share, just connect with
              me! You can reach me with these links.
            </p>
